...
팀 프로젝트가 끝난 뒤 실행되지 않던 두 프로젝트를 혼자 다시 살렸습니다.

- **everyWEAR (JSP/Servlet 쇼핑몰)** — 버전이 서로 다른 작업본을 비교해 Java 21·Tomcat 9 기준으로 복구하고,
  평문 비밀번호·결제 금액 위조·권한 없는 데이터 변경 같은 보안 문제를 고쳤습니다.
- **알고먹자 (Java Swing)** — macOS 환경에서 DB 연결 오류, 누락 테이블,
  DAO와 DB 스키마 불일치, 화면 흐름 문제를 개선했습니다.
...
<img src="https://img.shields.io/badge/Java-007396?style=flat-square&logo=openjdk&logoColor=white"/> <img src="https://img.shields.io/badge/JavaScript-F7DF1E?style=flat-square&logo=javascript&logoColor=black"/> <img src="https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white"/>
