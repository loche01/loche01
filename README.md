# 안녕하세요, 신입 Java 개발자 석인철입니다.

Java, JSP/Servlet, MySQL, Oracle DB 기반 프로젝트를 경험하며
웹 시스템 개발과 유지보수 역량을 쌓고 있습니다.

기존 Java Swing 프로젝트를 macOS 환경에서 복구하고,
DB 연결 오류, 누락 테이블, DAO와 DB 스키마 불일치, 화면 흐름 문제를 개선하며
실행 환경과 데이터베이스 구조를 함께 이해하는 경험을 했습니다.
...
| --------- | ----------------------------------- | ------------------------------------------------ |
| 알고먹자      | Java Swing 기반 식단·운동 관리 프로그램 복구 및 개선 | Java, Swing, MySQL, JDBC                         |
...
* GitHub: https://github.com/loche01/algomeokja-java-swing
...
* Notion Portfolio: 여기에 노션 공개 링크 입력
